...
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, XOR_GATE, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db JOSH, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
...
.ho_bo_po: db HO_OH, HOOTHOOT, HALF_ADDER, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
