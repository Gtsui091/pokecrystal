...
FalknerGroup:
	...
	db  7, HALF_ADDER,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
PryceGroup:
	...
	db 27, JOSH,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
WillGroup:
	...
	db 41, LINH,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
